        ...
        <div className="flex-1 overflow-y-auto px-8 pb-8 custom-scrollbar">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea 
                className="w-full bg-gray-50 border-none rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-red-200 outline-none h-24 resize-none"
            ...
            <div className="bg-red-50/30 rounded-2xl p-4 flex items-center justify-between">
              <div>
            ...
            <div className="flex items-center justify-end gap-4 pt-4">
              ...
              <button 
                type="submit"
                className="bg-[#DC2626] text-white px-8 py-2.5 rounded-full text-sm font-bold hover:bg-red-600 transition-all shadow-lg shadow-red-200"
              >
                Create Discount
              </button>
            </div>

          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-50 border-none rounded-2xl px-5 py-3.5 text-sm focus:ring-2 focus:ring-red-600/20"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-gray-50 border-none rounded-2xl px-5 py-3.5 text-sm focus:ring-2 focus:ring-red-600/20 resize-none"
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="w-5 h-5 rounded-lg border-gray-300 text-red-600 focus:ring-red-600/20"
                />
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="relative group aspect-[16/10] bg-gray-50 rounded-[2rem] overflow-hidden border-2 border-dashed border-gray-200 hover:border-red-600/50 transition-all">
                  {imagePreview ? (
                    <>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-gray-50 border-none rounded-2xl px-5 py-3.5 text-sm focus:ring-2 focus:ring-red-600/20 font-mono"

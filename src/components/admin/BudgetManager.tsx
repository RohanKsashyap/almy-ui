      ...
      <div className="bg-white border border-[#F3F4F6] rounded-[2rem] shadow-sm overflow-hidden">
        <div className="p-8">
          <div className="space-y-4">
            {budgets.map((b, idx) => (
              <div key={idx} className="flex gap-4 items-center bg-white border border-[#F3F4F6] rounded-2xl p-5 shadow-sm group transition-all hover:border-red-100">
                ...
                <div className="flex-1 grid grid-cols-4 gap-4">
                  ...
                  <div className="space-y-1">
                    <label className="text-[10px] font-bold uppercase tracking-widest text-[#9CA3AF]">Min (INR)</label>
                    <input 
                      type="number"
                      className="w-full text-sm font-semibold text-[#374151] border-none p-0 focus:ring-0" 
                      value={b.min} 
                  ...
                  <div className="space-y-1">
                    <label className="text-[10px] font-bold uppercase tracking-widest text-[#9CA3AF]">Max (INR)</label>
                    <input 
                      type="number"
                      className="w-full text-sm font-semibold text-[#374151] border-none p-0 focus:ring-0" 
                      value={b.max} 

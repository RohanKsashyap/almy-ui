      ...
      >
        ...
        <div className="w-full md:w-[350px] bg-[#FDFBFB] p-8 md:p-12 flex flex-col border-r border-gray-100 overflow-y-auto custom-scrollbar">
          <div className="flex-1 space-y-12">
            ...
            <div className="space-y-6">
              ...
              <div className="pt-6 border-t border-gray-100 flex justify-between items-end">
                <span className="text-[10px] font-black text-[#DC2626] uppercase tracking-[0.3em] mb-1">Total</span>
          ...
          <div className="space-y-4 mt-12 pt-6 border-t border-gray-50">
            <button className="w-full py-5 bg-[#DC2626] text-white rounded-[1.5rem] text-xs font-black uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-[#B91C1C] transition-all shadow-lg shadow-red-500/20">
              <Printer size={16} />
              Print Invoice
            </button>
            <button 
                    ...
                    <div className="flex-1 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                      ...
                      <div className="text-left sm:text-right w-full sm:w-auto">
                        ...
                        <div className="mt-4">
                          ...
                          <p className="text-sm font-black text-[#DC2626] tracking-tight">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-6 bg-red-100 rounded-md flex items-center justify-center">
                      <CreditCard size={14} className="text-[#DC2626]" />
                    </div>
                    <div>

    ...
    <div className="space-y-4 animate-in fade-in duration-500 pr-2">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-4xl font-black tracking-tighter text-gray-900 leading-none">Inventory<span className="text-[#DC2626]">.</span></h1>
        </div>
                        ...
                        >
                          ...
                          <td className="px-6 py-4 text-right">
                            <button 
                              ...
                              className="p-2 text-gray-400 hover:text-[#DC2626] hover:bg-red-50 rounded-lg transition-all opacity-0 group-hover:opacity-100"
                            >
                              <Edit size={16} />
                            </button>
                          </td>
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-[2rem] p-6 border border-gray-100 shadow-sm">
            ...
            <div className="flex gap-2 mt-6">
              ...
              <button 
                ...
                className="p-3 bg-white text-gray-400 hover:text-[#DC2626] rounded-2xl transition-all border border-red-50 shadow-sm disabled:opacity-50"
              >
          ...
          <div className="bg-white rounded-[2rem] p-6 border border-gray-100 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="text-[9px] font-bold uppercase tracking-widest text-[#DC2626] hover:underline">View All</button>
            </div>
            
            <div className="space-y-4">
              {[
                { type: 'admin', text: 'Admin added 24 units', time: '2 hours ago', icon: Plus, color: 'text-red-500 bg-red-50' },
            ...
            <div className="mt-6 flex justify-end">
               <button className="w-10 h-10 bg-[#DC2626] text-white rounded-xl flex items-center justify-center shadow-lg shadow-red-500/20 hover:scale-105 transition-transform">
                  <Plus size={18} />
               </button>
            </div>
          </div>
          ...
          <div className="bg-black rounded-[2rem] p-6 text-white relative overflow-hidden group cursor-pointer">
            <div className="absolute top-0 right-0 w-32 h-32 bg-red-500/10 blur-[60px] rounded-full -mr-12 -mt-12"></div>
            <div className="relative z-10">
              <div className="inline-flex items-center px-3 py-1 rounded-full bg-[#DC2626] text-[8px] font-bold uppercase tracking-widest mb-4">
                Atelier Insight
              </div>
              <h4 className="text-lg font-black leading-tight mb-4 tracking-tight">
                Save <span className="text-[#DC2626]">$1,240</span> monthly.
              </h4>

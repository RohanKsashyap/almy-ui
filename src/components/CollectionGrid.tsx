    ...
    <section className="py-12 md:py-24 px-6 lg:px-12 max-w-screen-2xl mx-auto overflow-hidden relative group/section">
      ...
      <div className="relative">
        ...
        <button 
          ...
          className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 z-10 bg-white/80 backdrop-blur-sm p-3 rounded-full shadow-lg border border-red-100 text-hot-pink opacity-0 group-hover/section:opacity-100 transition-opacity hidden md:block"
        >
          <ChevronLeft size={24} />
        </button>
        <button 
          onClick={() => handleScroll('right')}
          className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 z-10 bg-white/80 backdrop-blur-sm p-3 rounded-full shadow-lg border border-red-100 text-hot-pink opacity-0 group-hover/section:opacity-100 transition-opacity hidden md:block"
        >

      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleUpdateProfile} className="bg-white rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 border border-gray-100 shadow-sm mb-6 md:mb-8">
          <div className="flex items-center gap-3 mb-6 md:mb-8">
            <div className="w-8 h-8 bg-red-50 rounded-lg flex items-center justify-center text-[#DC2626]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-4 md:mb-6">
            <div>
              ...
              <input 
                ...
                className="w-full px-5 md:px-6 py-3 md:py-4 bg-[#f8f9fa] border-none rounded-2xl focus:ring-2 focus:ring-[#DC2626] outline-none transition-all placeholder:text-gray-400 font-medium"
                required
              />
            </div>
            <div>
          ...
          <div className="flex justify-end">
            <button 
              type="submit"
              disabled={loading}
              className="w-full sm:w-auto px-8 py-4 bg-[#DC2626] text-white font-bold rounded-2xl hover:opacity-90 transition-all shadow-lg shadow-red-100 flex items-center justify-center gap-2 disabled:opacity-70"
            >

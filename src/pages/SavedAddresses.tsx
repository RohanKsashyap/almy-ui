      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-8 md:mb-10">
          ...
          <button 
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 bg-[#DC2626] text-white px-6 py-3 rounded-full font-bold text-sm shadow-lg shadow-red-100 hover:opacity-90 transition-all"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-10">
              ...
              return (
                <div key={addr._id} className="bg-white rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-8 border border-gray-50 shadow-sm relative group overflow-hidden flex flex-col">
                  <div className="flex justify-between items-start mb-6">
                    <div className="w-12 h-12 bg-red-50 rounded-2xl flex items-center justify-center text-[#DC2626]">
          ...
          <button 
            onClick={() => handleOpenModal()}
            className="bg-transparent rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-8 border-2 border-dashed border-gray-200 hover:border-[#DC2626] hover:bg-white transition-all flex flex-col items-center justify-center group min-h-[250px] md:min-h-[300px]"
          >
            <div className="w-12 h-12 bg-gray-50 group-hover:bg-red-50 rounded-full flex items-center justify-center text-gray-300 group-hover:text-[#DC2626] mb-4 transition-all">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <select 
                        ...
                        className="w-full px-5 py-3 bg-[#f8f9fa] border-none rounded-xl focus:ring-2 focus:ring-[#DC2626] outline-none font-medium"
                      >
                  ...
                  <div className="flex items-center gap-2 pt-2">
                    <input 
                      ...
                      className="w-4 h-4 text-[#DC2626] focus:ring-[#DC2626] rounded"
                    />
                  ...
                  <div className="pt-6">
                    <button 
                      type="submit"
                      disabled={loading}
                      className="w-full py-4 bg-[#DC2626] text-white font-bold rounded-2xl shadow-lg shadow-red-100 flex items-center justify-center gap-2 disabled:opacity-70"
                    >
        ...
        <div className="bg-white rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-8 border border-gray-50 shadow-sm overflow-hidden">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            ...
            <button className="text-sm font-bold text-[#DC2626] hover:underline">View Map Mode</button>
          </div>
          ...
          <div className="relative rounded-[1.5rem] md:rounded-[2rem] overflow-hidden aspect-[4/3] md:aspect-[21/9] bg-gray-100 group">
            ...
            <div className="absolute inset-0 flex items-center justify-center p-4">
              <div className="bg-white p-3 md:p-4 md:pl-6 md:pr-8 rounded-full shadow-2xl border border-gray-100 flex items-center gap-3 md:gap-4 max-w-full overflow-hidden">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-[#DC2626] rounded-full flex items-center justify-center text-white flex-shrink-0">

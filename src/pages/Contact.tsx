...
export default function Contact() {
  const site = loadSite({
    hero: { title: "ALMY'S", subtitle: '', slides: [], bannerImage: '', bannerTitle: '', bannerSubtitle: '', bannerCtaText: '', bannerCtaHref: '' },
    social: []
  } as any);
  ...
  return (
    <main className="bg-white min-h-screen">
      <SEO 
        title="Contact Us"
        description="Have a question about our dresses or your order? Contact the ALMY'S concierge team. We're here to help with all your inquiries."
        canonical="https://www.Almy's.com.au/contact"
      />
      {/* Hero Section */}
      ...
      <section className="py-20 px-6 lg:px-12 max-w-screen-2xl mx-auto -mt-20 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-12 py-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="flex gap-6 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">concierge@Almy's.com</p>
                    <p className="text-gray-600">support@Almy's.com</p>
                  </div>
                </div>
            ...
            {/* Map Placeholder */}
            <div className="relative h-80 rounded-[2rem] overflow-hidden group shadow-xl bg-red-50">
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <div className="relative">
                  ...
                  <div className="absolute top-full left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm px-6 py-2 rounded-full shadow-xl whitespace-nowrap border border-gray-100">
                    <span className="font-bold text-gray-900 uppercase tracking-widest text-[10px]">ALMY'S FLAGSHIP STORE</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* FAQ Section */}
      <section className="py-24 bg-red-50/50 mt-12 text-center">

  ...
  useEffect(() => {
    ...
    if (b) {
      ...
      if (match) { setMinPrice(match.min); setMaxPrice(match.max); }
        ...
        else if (b === '100plus') { setMinPrice(100); setMaxPrice(1000000); }
      }
    }
  ...
  return (
    <main className="bg-white pt-32 pb-24">
      <SEO 
        ...
        description={`Explore our collection of ${type !== 'All' ? type.toLowerCase() : 'beautiful'} dresses for girls aged 7-13. Find the perfect outfit for any occasion at ALMY'S.`}
        canonical="https://www.Almy's.com.au/shop"
      />

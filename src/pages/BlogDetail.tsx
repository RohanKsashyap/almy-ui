  ...
  if (!post) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center space-y-4">
        ...
        <Link to="/journal" className="text-red-600 uppercase text-xs tracking-widest font-bold border-b border-red-600">Back to Journal</Link>
      </div>
    );
  }
    ...
    <article className="bg-white min-h-screen pb-24">
      ...
      <div className="relative h-[70vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 p-8 md:p-16 max-w-7xl mx-auto text-white">
          <Link to="/journal" className="inline-flex items-center gap-2 mb-8 text-xs tracking-[0.2em] uppercase font-semibold hover:text-red-400 transition-colors">
            <ArrowLeft size={16} /> Back to Journal
          </Link>
          <div className="max-w-3xl space-y-6">
            <span className="text-xs uppercase tracking-[0.3em] font-bold text-red-400">{post.category}</span>
      ...
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="prose prose-lg max-w-none">
          <p className="text-xl text-gray-600 italic font-serif leading-relaxed mb-12 border-l-4 border-red-100 pl-8 break-words">
            {post.excerpt}
          </p>
          <div 

    ...
    <div className="max-w-[1400px] mx-auto space-y-8 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <button 
          onClick={handleSave}
          disabled={isSaving}
          className="bg-[#DC2626] text-white px-8 py-4 rounded-3xl text-sm font-bold flex items-center gap-3 hover:bg-[#B91C1C] transition-all shadow-xl shadow-red-500/20 disabled:opacity-70 disabled:cursor-not-allowed"
        >
          {isSaving ? (
            <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-red-50/30 p-4 rounded-2xl flex items-center justify-between border border-red-100">
                <div>
              ...
              <div className="space-y-3">
                ...
                <div className="relative group">
                  <div className={`
                    ...
                    group-hover:border-red-100 group-hover:bg-red-50/30
                  `}>
                    {isUploading ? (
                ...
                <div className="flex gap-4">
                  <div className="flex-1 relative">
                    <input 
                      ...
                      className="w-full bg-white border border-gray-100 rounded-2xl px-6 py-4 text-sm font-medium focus:ring-2 focus:ring-red-500/10 transition-all placeholder:text-gray-300 shadow-sm"
                      value={imageUrlInput}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input 
                    type="text" 
                    className="w-full bg-gray-50 border-none rounded-2xl px-6 py-4 text-sm font-medium focus:ring-2 focus:ring-red-500/10 transition-all placeholder:text-gray-300"
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input 
                    type="text" 
                    className="w-full bg-gray-50 border-none rounded-2xl px-6 py-4 text-sm font-medium focus:ring-2 focus:ring-red-500/10"
                ...
                <div className="md:col-span-2 space-y-2">
                  ...
                  <textarea 
                    className="w-full bg-gray-50 border-none rounded-2xl px-6 py-4 text-sm font-medium focus:ring-2 focus:ring-red-500/10 h-32 resize-none"
        ...
        <div className="space-y-6">
          ...
          {/* Pro Tip Card */}
          <div className="bg-[#FEF2F2] p-8 rounded-[2rem] border border-red-100">
            <div className="flex items-center gap-3 mb-4 text-[#DC2626]">
              <div className="w-6 h-6 rounded-full bg-white flex items-center justify-center text-[10px] font-bold border border-red-100">i</div>
            ...
            <button className="flex items-center gap-2 text-[#DC2626] text-xs font-bold uppercase tracking-wider mt-6 hover:underline group">
              View Live Preview

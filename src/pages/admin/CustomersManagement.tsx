      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-2xl text-sm font-bold transition-all shadow-lg shadow-red-200"
          >
            <Plus size={18} />
            Add Customer
          </button>
                ...
                <tr key={user._id} className="group hover:bg-gray-50/50 transition-colors">
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-red-100 to-red-50 flex items-center justify-center text-red-600 font-bold text-sm overflow-hidden border-2 border-white shadow-sm">
                  ...
                  <td className="px-8 py-6 text-sm font-bold text-center">₹{calculateTotalSpent(user).toLocaleString('en-IN')}</td>
                    ...
                    {activeMenuId === user._id && (
                      ...
                      >
                        <button 
                          ...
                          className="w-full px-4 py-2.5 text-left text-xs font-bold text-gray-600 hover:bg-red-50 hover:text-red-600 flex items-center gap-3 transition-colors"
                        >
                          <Eye size={16} />
                          View Details
                        </button>

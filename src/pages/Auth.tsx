      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white h-full">
          <div className="flex items-center gap-2 mb-8">
            ...
            <span className="font-bold tracking-widest text-lg uppercase">Almy's</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {!isLogin && (
              <div>
                ...
                <input 
                  ...
                  className="w-full px-5 py-4 bg-white border border-gray-200 rounded-2xl focus:ring-2 focus:ring-[#DC2626] focus:border-transparent outline-none transition-all placeholder:text-gray-400"
                  required
                />
              </div>
            )}
            ...
            <div className="flex items-center gap-3">
              <input 
                ...
                onChange={handleInputChange}
                className="w-5 h-5 rounded-lg border-gray-300 text-[#DC2626] focus:ring-[#DC2626] cursor-pointer"
              />
            ...
            <button 
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-[#DC2626] text-white font-bold rounded-2xl hover:opacity-90 transition-all shadow-lg shadow-red-200 disabled:opacity-70 flex items-center justify-center"
            >
              {loading ? (

      ...
      <DashboardLayout>
        <div className="max-w-6xl mx-auto text-center py-20">
          ...
          <button 
            ...
            className="px-8 py-3 bg-[#DC2626] text-white rounded-full font-bold shadow-lg shadow-red-100"
          >
            Start Shopping
          </button>
        </div>
    ...
    <DashboardLayout>
      <div className="max-w-6xl mx-auto">
        <button 
          ...
          className="flex items-center gap-2 text-[#DC2626] text-xs font-bold uppercase tracking-widest mb-4 hover:opacity-80 transition-opacity"
        >
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 mb-8">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-6 py-2.5 bg-[#DC2626] text-white rounded-full text-sm font-bold hover:opacity-90 transition-all shadow-md shadow-red-100">
          ...
          <div className="col-span-12 lg:col-span-8 space-y-6 md:space-y-8">
            ...
            <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-50">
              <div className="flex justify-between items-center mb-10">
                ...
                <span className="px-3 py-1 bg-red-50 text-[#DC2626] text-[10px] font-bold rounded-full uppercase tracking-wider">
              ...
              <div className="relative mb-12 px-2">
                ...
                <div className={`absolute top-1/2 left-0 h-1 bg-[#DC2626] -translate-y-1/2 rounded-full transition-all duration-1000 ${
              ...
              <div className="bg-[#fdf2f7] rounded-2xl p-4 flex items-center gap-4 border border-[#fce4ee]">
                <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-[#DC2626] shadow-sm">
            ...
            <div>
              ...
              <div className="space-y-4">
                {order.products.map((item, idx) => (
                  <div key={idx} className="bg-white p-4 md:p-5 rounded-[1.5rem] md:rounded-[2rem] shadow-sm border border-gray-50 flex flex-col sm:flex-row sm:items-center justify-between gap-4 group hover:border-red-100 transition-colors">
                    <div className="flex items-center gap-4 md:gap-6">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4">
                          <button className="text-[10px] font-bold text-[#DC2626] uppercase tracking-widest hover:underline">Track</button>
            ...
            <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-50">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex justify-between text-sm font-medium">
                  ...
                  <span className={order.shippingFee ? "text-gray-900" : "text-[#DC2626] font-bold"}>
              ...
              <div className="bg-[#fdf2f7] rounded-2xl p-4 flex items-center justify-between border border-[#fce4ee]">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-[#DC2626] shadow-sm flex-shrink-0">
                    <ShoppingBag className="w-5 h-5" />
                  </div>
                  <div className="min-w-0">
                    <p className="text-[8px] font-bold text-[#DC2626] uppercase tracking-widest">Payment Method</p>
